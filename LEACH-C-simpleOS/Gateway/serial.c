...
/* Set up stdio to use the uart (serial) for input and output */
...
static unsigned char serial_initialised=0;
void serial_init(unsigned long baud)
{
   baud = baud/10;
   baud = ((hw_timer_cpuf()/16)/baud)+5;
   baud = (baud/10)-1;
